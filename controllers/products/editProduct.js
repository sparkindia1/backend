        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma_1.prisma.product.update({
                        ...
                        data: __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, req.body), (req.body.categoryId && { categoryId: Number(req.body.categoryId) })), (req.body.description && { description: req.body.description })), (req.body.imageUrl && { imageUrl: req.body.imageUrl })), (req.body.levelOneLimit && { levelOneLimit: req.body.levelOneLimit })), (req.body.levelTwoLimit && { levelTwoLimit: req.body.levelTwoLimit })), (req.body.levelThreeLimit && {
                        ...
                        })), (req.body.name && { name: req.body.name })), (req.body.pricePerProductLevelOne && {
