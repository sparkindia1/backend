    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma_1.prisma.tempUser.create({
                        data: { otp: otp, userId: user.id }
                    })];
            case 2:
                _a.sent();
                console.log({ otp: otp, email: email, userId: user.id });
...
var resetPassword = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, userId, otp, password, user, hashedPassword;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, userId = _a.userId, otp = _a.otp, password = _a.password;
